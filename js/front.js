...
// Set a timeout to show the chat message after 7 seconds
setTimeout(showChatMessage, 7000);

// Set a timeout to hide the chat message after 12 seconds
setTimeout(hideChatMessage, 12000);
